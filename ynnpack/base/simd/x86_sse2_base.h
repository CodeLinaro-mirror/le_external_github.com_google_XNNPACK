...
// This implementation of memcpy takes a constant upper bound for the number
// elements.
template <typename T>
YNN_ALWAYS_INLINE void memcpy_small(T* dst, const T* src, size_t n,
...
vec<T, Init::N> partial_load_sse(const T* ptr, size_t n, Init src) {
  ...
  memcpy_small(lanes, ptr, n, Init::N);
