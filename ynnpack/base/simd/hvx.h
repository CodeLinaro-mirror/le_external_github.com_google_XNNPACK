...
YNN_ALWAYS_INLINE float horizontal_sum(f32x32 x) {
  ...
  // each add.
  x.v = Q6_Vsf_equals_Vqf32(Q6_Vsf_vadd_VsfVsf(x.v, Q6_V_vror_VR(x.v, 64)));
  x.v = Q6_Vsf_equals_Vqf32(Q6_Vsf_vadd_VsfVsf(x.v, Q6_V_vror_VR(x.v, 32)));
  x.v = Q6_Vsf_equals_Vqf32(Q6_Vsf_vadd_VsfVsf(x.v, Q6_V_vror_VR(x.v, 16)));
  x.v = Q6_Vsf_equals_Vqf32(Q6_Vsf_vadd_VsfVsf(x.v, Q6_V_vror_VR(x.v, 8)));
  x.v = Q6_Vsf_equals_Vqf32(Q6_Vsf_vadd_VsfVsf(x.v, Q6_V_vror_VR(x.v, 4)));
  return *(float*)&x.v;
}
