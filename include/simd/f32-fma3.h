...
// SIMD vector type for f32 using FMA3.
...
// Static mask table used for masked load/store operations.
const int32_t XNN_WEAK_SYMBOL mask_table_fma3_f32[14] = {
...
XNN_INLINE xnn_simd_f32_t xnn_load_tail_f32(const float* input,
  ...
  const __m256i vmask = _mm256_loadu_si256(
      (const __m256i*)(&mask_table_fma3_f32[7] - num_elements));
