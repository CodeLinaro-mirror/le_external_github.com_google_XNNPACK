...
using EvenSplit4TestF16 = EvenSplit4Test<xnn_float16_t>;
...
TEST_F(EvenSplit4TestF16, matches_operator_api)
{
  ...
  ASSERT_EQ(
    xnn_status_success,
    xnn_setup_copy_nc_x16(op2, (xnn_float16_t*) input.data() + op1->channels, operator_output2.data()));
  ASSERT_EQ(
    xnn_status_success,
    xnn_setup_copy_nc_x16(op3, (xnn_float16_t*) input.data() + op1->channels * 2, operator_output3.data()));
  ASSERT_EQ(
    xnn_status_success,
    xnn_setup_copy_nc_x16(op4, (xnn_float16_t*) input.data() + op1->channels * 3, operator_output4.data()));
