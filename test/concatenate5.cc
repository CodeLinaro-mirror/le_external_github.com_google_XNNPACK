...
using Concatenate5TestF16 = Concatenate5Test<xnn_float16_t>;
...
TEST_F(Concatenate5TestF16, matches_operator_api)
{
  ...
  ASSERT_EQ(
    xnn_status_success,
    xnn_setup_copy_nc_x16(op2, input2.data(), (xnn_float16_t*) operator_output.data() + op1->channels));
  ASSERT_EQ(
    xnn_status_success,
    xnn_setup_copy_nc_x16(op3, input3.data(), (xnn_float16_t*) operator_output.data() + op1->channels + op2->channels));
  ASSERT_EQ(
    xnn_status_success,
    xnn_setup_copy_nc_x16(
      op4, input4.data(), (xnn_float16_t*) operator_output.data() + op1->channels + op2->channels + op3->channels));
  ASSERT_EQ(
    xnn_status_success,
    xnn_setup_copy_nc_x16(
      op5, input5.data(), (xnn_float16_t*) operator_output.data() + op1->channels + op2->channels + op3->channels + op4->channels));
