...
TEST(F32_VRSQRT__SCALAR_RSQRT_U12, batch_eq_12) {
  VUnaryMicrokernelTester()
    .batch_size(12)
    .Test(xnn_f32_vrsqrt_ukernel__scalar_rsqrt_u12);
}

TEST(F32_VRSQRT__SCALAR_RSQRT_U12, batch_div_12) {
...
TEST(F32_VRSQRT__SCALAR_RSQRT_U12, batch_lt_12) {
...
TEST(F32_VRSQRT__SCALAR_RSQRT_U12, batch_gt_12) {
...
TEST(F32_VRSQRT__SCALAR_RSQRT_U12, inplace) {
...
TEST(F32_VRSQRT__SCALAR_RSQRT_U16, batch_eq_16) {
  VUnaryMicrokernelTester()
    .batch_size(16)
    .Test(xnn_f32_vrsqrt_ukernel__scalar_rsqrt_u16);
}

TEST(F32_VRSQRT__SCALAR_RSQRT_U16, batch_div_16) {
...
TEST(F32_VRSQRT__SCALAR_RSQRT_U16, batch_lt_16) {
...
TEST(F32_VRSQRT__SCALAR_RSQRT_U16, batch_gt_16) {
...
TEST(F32_VRSQRT__SCALAR_RSQRT_U16, inplace) {
  ...
  TEST(F32_VRSQRT__SSE_RSQRT_U4, batch_eq_4) {
    ...
    VUnaryMicrokernelTester()
      .batch_size(4)
      .Test(xnn_f32_vrsqrt_ukernel__sse_rsqrt_u4);
  }
  ...
  TEST(F32_VRSQRT__SSE_RSQRT_U12, batch_eq_12) {
    ...
    VUnaryMicrokernelTester()
      .batch_size(12)
      .Test(xnn_f32_vrsqrt_ukernel__sse_rsqrt_u12);
  }
  ...
  TEST(F32_VRSQRT__SSE_RSQRT_U20, batch_eq_20) {
    ...
    VUnaryMicrokernelTester()
      .batch_size(20)
      .Test(xnn_f32_vrsqrt_ukernel__sse_rsqrt_u20);
  }
  ...
  TEST(F32_VRSQRT__SSE_RSQRT_U24, batch_eq_24) {
    ...
    VUnaryMicrokernelTester()
      .batch_size(24)
      .Test(xnn_f32_vrsqrt_ukernel__sse_rsqrt_u24);
  }
  ...
  TEST(F32_VRSQRT__SSE_RSQRT_U28, batch_eq_28) {
    ...
    VUnaryMicrokernelTester()
      .batch_size(28)
      .Test(xnn_f32_vrsqrt_ukernel__sse_rsqrt_u28);
  }
  ...
  TEST(F32_VRSQRT__SSE_RSQRT_U32, batch_eq_32) {
    ...
    VUnaryMicrokernelTester()
      .batch_size(32)
      .Test(xnn_f32_vrsqrt_ukernel__sse_rsqrt_u32);
  }
  ...
  TEST(F32_VRSQRT__FMA3_RSQRT_U8, batch_eq_8) {
    ...
    VUnaryMicrokernelTester()
      .batch_size(8)
      .Test(xnn_f32_vrsqrt_ukernel__fma3_rsqrt_u8, xnn_init_f32_rsqrt_avx_params);
  }
  ...
  TEST(F32_VRSQRT__FMA3_RSQRT_U16, batch_eq_16) {
    ...
    VUnaryMicrokernelTester()
      .batch_size(16)
      .Test(xnn_f32_vrsqrt_ukernel__fma3_rsqrt_u16, xnn_init_f32_rsqrt_avx_params);
  }
  ...
  TEST(F32_VRSQRT__FMA3_RSQRT_U24, batch_eq_24) {
    ...
    VUnaryMicrokernelTester()
      .batch_size(24)
      .Test(xnn_f32_vrsqrt_ukernel__fma3_rsqrt_u24, xnn_init_f32_rsqrt_avx_params);
  }
  ...
  TEST(F32_VRSQRT__FMA3_RSQRT_U32, batch_eq_32) {
    ...
    VUnaryMicrokernelTester()
      .batch_size(32)
      .Test(xnn_f32_vrsqrt_ukernel__fma3_rsqrt_u32, xnn_init_f32_rsqrt_avx_params);
  }
  ...
  TEST(F32_VRSQRT__FMA3_RSQRT_U40, batch_eq_40) {
    ...
    VUnaryMicrokernelTester()
      .batch_size(40)
      .Test(xnn_f32_vrsqrt_ukernel__fma3_rsqrt_u40, xnn_init_f32_rsqrt_avx_params);
  }
  ...
  TEST(F32_VRSQRT__FMA3_RSQRT_U48, batch_eq_48) {
    ...
    VUnaryMicrokernelTester()
      .batch_size(48)
      .Test(xnn_f32_vrsqrt_ukernel__fma3_rsqrt_u48, xnn_init_f32_rsqrt_avx_params);
  }
  ...
  TEST(F32_VRSQRT__FMA3_RSQRT_U56, batch_eq_56) {
    ...
    VUnaryMicrokernelTester()
      .batch_size(56)
      .Test(xnn_f32_vrsqrt_ukernel__fma3_rsqrt_u56, xnn_init_f32_rsqrt_avx_params);
  }
  ...
  TEST(F32_VRSQRT__FMA3_RSQRT_U64, batch_eq_64) {
    ...
    VUnaryMicrokernelTester()
      .batch_size(64)
      .Test(xnn_f32_vrsqrt_ukernel__fma3_rsqrt_u64, xnn_init_f32_rsqrt_avx_params);
  }
  ...
  TEST(F32_VRSQRT__AVX512F_RSQRT_U48, batch_eq_48) {
    ...
    VUnaryMicrokernelTester()
      .batch_size(48)
      .Test(xnn_f32_vrsqrt_ukernel__avx512f_rsqrt_u48);
  }
  ...
  TEST(F32_VRSQRT__AVX512F_RSQRT_U64, batch_eq_64) {
    ...
    VUnaryMicrokernelTester()
      .batch_size(64)
      .Test(xnn_f32_vrsqrt_ukernel__avx512f_rsqrt_u64);
  }
  ...
  TEST(F32_VRSQRT__AVX512F_RSQRT_U80, batch_eq_80) {
    ...
    VUnaryMicrokernelTester()
      .batch_size(80)
      .Test(xnn_f32_vrsqrt_ukernel__avx512f_rsqrt_u80);
  }
  ...
  TEST(F32_VRSQRT__AVX512F_RSQRT_U96, batch_eq_96) {
    ...
    VUnaryMicrokernelTester()
      .batch_size(96)
      .Test(xnn_f32_vrsqrt_ukernel__avx512f_rsqrt_u96);
  }
  ...
  TEST(F32_VRSQRT__AVX512F_RSQRT_U112, batch_eq_112) {
    ...
    VUnaryMicrokernelTester()
      .batch_size(112)
      .Test(xnn_f32_vrsqrt_ukernel__avx512f_rsqrt_u112);
  }
  ...
  TEST(F32_VRSQRT__AVX512F_RSQRT_U128, batch_eq_128) {
    ...
    VUnaryMicrokernelTester()
      .batch_size(128)
      .Test(xnn_f32_vrsqrt_ukernel__avx512f_rsqrt_u128);
  }
