...
using XnnTest = XnnAvgPoolTest<AvgPoolMicrokernelTester::TestF32AvgPoolFns>;
using XnnTestParam = XnnAvgPoolTestParam<AvgPoolMicrokernelTester::TestF32AvgPoolFns>;
...
INSTANTIATE_TEST_SUITE_P(f32_avgpool_minmax,
                         XnnTest,
