...
using XnnTest = XnnAvgPoolTest<AvgPoolMicrokernelTester::TestF32PAvgPoolFns>;
using XnnTestParam = XnnAvgPoolTestParam<AvgPoolMicrokernelTester::TestF32PAvgPoolFns>;
...
INSTANTIATE_TEST_SUITE_P(f32_pavgpool_minmax,
                         XnnTest,
