...
void BinaryElementwiseOperatorTester::TestQS8() const {
  ...
  std::vector<int8_t> input1(XNN_EXTRA_BYTES / sizeof(xnn_float16_t) +
                             num_input1_elements());
  std::vector<int8_t> input2(XNN_EXTRA_BYTES / sizeof(xnn_float16_t) +
                             num_input2_elements());
...
void BinaryElementwiseOperatorTester::TestQU8() const {
  ...
  std::vector<uint8_t> input1(XNN_EXTRA_BYTES / sizeof(xnn_float16_t) +
                              num_input1_elements());
  std::vector<uint8_t> input2(XNN_EXTRA_BYTES / sizeof(xnn_float16_t) +
                              num_input2_elements());
...
void BinaryElementwiseOperatorTester::TestF16() const {
  ...
  std::vector<xnn_float16_t> input1(XNN_EXTRA_BYTES / sizeof(xnn_float16_t) +
                               num_input1_elements());
  std::vector<xnn_float16_t> input2(XNN_EXTRA_BYTES / sizeof(xnn_float16_t) +
                               num_input2_elements());
  std::vector<xnn_float16_t> output(num_output_elements);
  std::vector<float> output_ref(num_output_elements);
  for (size_t iteration = 0; iteration < iterations(); iteration++) {
