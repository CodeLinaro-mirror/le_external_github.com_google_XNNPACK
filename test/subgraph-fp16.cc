...
TEST(SUBGRAPH_FP16, with_static_value) {
  ...
  ASSERT_EQ(static_cast<const xnn_float16_t*>(static_value->data)[0], 1.0f);
  ASSERT_EQ(static_cast<const xnn_float16_t*>(static_value->data)[1], 2.0f);
  ASSERT_EQ(static_cast<const xnn_float16_t*>(static_value->data)[2], 3.0f);
...
TEST(SUBGRAPH_FP16, convolution_weights_used_by_another_node) {
  ...
  ASSERT_EQ(static_cast<const xnn_float16_t*>(static_value->data)[1], 2.0f);
  ASSERT_EQ(static_cast<const xnn_float16_t*>(static_value->data)[2], 3.0f);
  ASSERT_EQ(static_cast<const xnn_float16_t*>(static_value->data)[3], 4.0f);
  ASSERT_EQ(static_cast<const xnn_float16_t*>(static_value->data)[4], 5.0f);
  ASSERT_EQ(static_cast<const xnn_float16_t*>(static_value->data)[5], 6.0f);
