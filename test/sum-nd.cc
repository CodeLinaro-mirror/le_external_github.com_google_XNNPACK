...
TEST(SUM_ND_F16, reduce_first_axis) {
  SumOperatorTester()
...
TEST(SUM_ND_F16, reduce_last_axis) {
  SumOperatorTester()
    .input_shape({kDim1, kDim2})
    .reduction_axes({1})
    .TestF16();
...
TEST(SUM_ND_F16, reduce_6d_multithreaded) {
  std::vector<size_t> reduction_axes;
  for (uint32_t bm1 = 1; bm1 < (uint32_t(1) << 6); bm1++) {
    const bool reduce_dim1 = (bm1 & (uint32_t(1) << 0)) != 0;
    const bool reduce_dim2 = (bm1 & (uint32_t(1) << 1)) != 0;
...
TEST(SUM_ND_F32, reduce_first_axis) {
  SumOperatorTester()
    .input_shape({kDim1, kDim2})
    .reduction_axes({0})
    .TestF32();
...
TEST(SUM_ND_F32, reduce_last_axis) {
  SumOperatorTester()
...
TEST(SUM_ND_F32, reduce_last_axis2) {
  SumOperatorTester()
    .input_shape({kDim1, kDim2, kDim3})
    .reduction_axes({0,2})
    .TestF32();
...
TEST(SUM_ND_F32, reduce_6d_multithreaded) {
  std::vector<size_t> reduction_axes;
  for (uint32_t bm1 = 1; bm1 < (uint32_t(1) << 6); bm1++) {
    const bool reduce_dim1 = (bm1 & (uint32_t(1) << 0)) != 0;
    const bool reduce_dim2 = (bm1 & (uint32_t(1) << 1)) != 0;
...
TEST(SUM_ND_QS8, reduce_first_axis) {
  SumOperatorTester()
    .input_shape({kDim1, kDim2})
    .reduction_axes({0})
    .TestQS8();
...
TEST(SUM_ND_QS8, reduce_last_axis) {
  SumOperatorTester()
    .input_shape({kDim1, kDim2, kDim3})
    .reduction_axes({0,2})
    .TestQS8();
...
TEST(SUM_ND_QS8, reduce_last_axis2) {
  SumOperatorTester()
    .input_shape({kDim1, kDim2, kDim3})
    .reduction_axes({0,2})
    .TestQS8();
...
TEST(SUM_ND_QS8, reduce_6d_multithreaded) {
  std::vector<size_t> reduction_axes;
  for (uint32_t bm1 = 1; bm1 < (uint32_t(1) << 6); bm1++) {
    const bool reduce_dim1 = (bm1 & UINT32_C(1)) != 0;
    const bool reduce_dim2 = (bm1 & UINT32_C(2)) != 0;
...
TEST(SUM_ND_QU8, reduce_first_axis) {
  SumOperatorTester()
    .input_shape({kDim1, kDim2})
    .reduction_axes({0})
    .TestQU8();
...
TEST(SUM_ND_QU8, reduce_last_axis) {
  SumOperatorTester()
    .input_shape({kDim1, kDim2, kDim3})
    .reduction_axes({0,2})
    .TestQU8();
...
TEST(SUM_ND_QU8, reduce_last_axis2) {
  SumOperatorTester()
    .input_shape({kDim1, kDim2, kDim3})
    .reduction_axes({0,2})
    .TestQU8();
...
TEST(SUM_ND_QU8, reduce_6d_multithreaded) {
  std::vector<size_t> reduction_axes;
  for (uint32_t bm1 = 1; bm1 < (uint32_t(1) << 6); bm1++) {
    const bool reduce_dim1 = (bm1 & UINT32_C(1)) != 0;
    const bool reduce_dim2 = (bm1 & UINT32_C(2)) != 0;
