...
using XnnTest = XnnAvgPoolTest<AvgPoolMicrokernelTester::TestF16PAvgPoolFns>;
using XnnTestParam = XnnAvgPoolTestParam<AvgPoolMicrokernelTester::TestF16PAvgPoolFns>;
...
INSTANTIATE_TEST_SUITE_P(f16_pavgpool_minmax,
                         XnnTest,
