...
static void init_f32_gemm_config(void) {
    ...
    if (hardware_config->use_arm_neon) {
        ...
        switch (cpuinfo_get_uarch(0)->uarch) {
          ...
          case cpuinfo_uarch_kryo:
            ...
            f32_gemm_config.pack_gemm_gio = (xnn_packw_gemm_gio_ukernel_fn) xnn_x32_packw_gemm_gio_ukernel_x8_scalar;
    ...
    if (hardware_config->use_x86_fma3) {
      ...
      f32_gemm_config.init.f32 = xnn_init_f32_minmax_scalar_params;
      f32_gemm_config.pack_gemm_gio = (xnn_packw_gemm_gio_ukernel_fn) xnn_x32_packw_gemm_gio_ukernel_x8__scalar;
