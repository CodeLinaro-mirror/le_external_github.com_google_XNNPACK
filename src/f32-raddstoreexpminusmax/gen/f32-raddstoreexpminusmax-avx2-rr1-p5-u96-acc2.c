...
void xnn_f32_raddstoreexpminusmax_ukernel__avx2_rr1_p5_u96_acc2(
    size_t batch,
    const float* input,
    const float* max,
    float* output,
    ...
    const union xnn_f32_expminus_params params[restrict XNN_MIN_ELEMENTS(1)])
{
  ...
  XNN_FORCE_STACK const __m256 vlog2e = _mm256_set1_ps(0x1.715476p+0f);
  XNN_FORCE_STACK const __m256 vmagic_bias = _mm256_set1_ps(0x1.8000FEp23f);
  XNN_FORCE_STACK const __m256 vminus_ln2 = _mm256_set1_ps(-0x1.62E430p-1f);
  XNN_FORCE_STACK const __m256 vc5 = _mm256_set1_ps(0x1.0F9F9Cp-7f);
  XNN_FORCE_STACK const __m256 vc4 = _mm256_set1_ps(0x1.573A1Ap-5f);
  XNN_FORCE_STACK const __m256 vc3 = _mm256_set1_ps(0x1.555A80p-3f);
  XNN_FORCE_STACK const __m256 vc2 = _mm256_set1_ps(0x1.FFFDC6p-2f);
  XNN_FORCE_STACK const __m256 vc1 = _mm256_set1_ps(0x1.FFFFF6p-1f);
  XNN_FORCE_STACK const __m256 vdenorm_cutoff = _mm256_set1_ps(-0x1.5D589Ep6f);
