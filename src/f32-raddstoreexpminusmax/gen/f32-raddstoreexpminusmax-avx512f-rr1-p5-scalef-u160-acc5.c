...
void xnn_f32_raddstoreexpminusmax_ukernel__avx512f_rr1_p5_scalef_u160_acc5(
    size_t batch,
    const float* input,
    const float* max,
    float* output,
    ...
    const union xnn_f32_expminus_params params[restrict XNN_MIN_ELEMENTS(1)])
{
  ...
  XNN_FORCE_STACK const __m512 vlog2e = _mm512_set1_ps(0x1.715476p+0f);
  ...
  XNN_FORCE_STACK const __m512 vc0 = _mm512_set1_ps(1.0f);
