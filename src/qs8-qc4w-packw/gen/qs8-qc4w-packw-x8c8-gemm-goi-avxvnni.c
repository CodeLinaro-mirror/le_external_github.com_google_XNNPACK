...
// convert a vector from packed nibbles to planar, KR=8 at a time
// vl is the low nibbles, shifted to the upper 4 bits (v << 4)
// vh is the high nibbles (v & 0xF0)
static XNN_INTRINSIC
__m256i _mm256_packed2planar(__m256i vl, const __m256i vh) {
   const __m256i v0 = _mm256_shuffle_epi32(vl, _MM_SHUFFLE(3, 2, 2, 0));
   const __m256i v1 = _mm256_shuffle_epi32(vh, _MM_SHUFFLE(3, 2, 2, 0));
   const __m256i v2 = _mm256_shuffle_epi32(vl, _MM_SHUFFLE(3, 2, 3, 1));
   const __m256i v3 = _mm256_shuffle_epi32(vh, _MM_SHUFFLE(3, 2, 3, 1));
   const __m256i v01 = _mm256_unpacklo_epi8(v0, v1);
   const __m256i v23 = _mm256_unpacklo_epi8(v2, v3);
  ...
  do {
    ...
    for (;n >= 8; n -= 8) {
      ...
      for (; k >= 32; k -= 32) {
        ...
        vacc0 = _mm256_dpbusd_avx_epi32(vacc0, vone, vh0_0);
        vacc0 = _mm256_dpbusd_avx_epi32(vacc0, vone, vl0_0);
        v0_0 = _mm256_packed2planar(vl0_0, vh0_0);
        ...
        vacc0 = _mm256_dpbusd_avx_epi32(vacc0, vone, vh0_1);
        vacc0 = _mm256_dpbusd_avx_epi32(vacc0, vone, vl0_1);
        v0_1 = _mm256_packed2planar(vl0_1, vh0_1);
        ...
        vacc0 = _mm256_dpbusd_avx_epi32(vacc0, vone, vh0_2);
        vacc0 = _mm256_dpbusd_avx_epi32(vacc0, vone, vl0_2);
        v0_2 = _mm256_packed2planar(vl0_2, vh0_2);
        ...
        vacc0 = _mm256_dpbusd_avx_epi32(vacc0, vone, vh0_3);
        vacc0 = _mm256_dpbusd_avx_epi32(vacc0, vone, vl0_3);
        v0_3 = _mm256_packed2planar(vl0_3, vh0_3);
        ...
        vacc4 = _mm256_dpbusd_avx_epi32(vacc4, vone, vh4_0);
        vacc4 = _mm256_dpbusd_avx_epi32(vacc4, vone, vl4_0);
        v4_0 = _mm256_packed2planar(vl4_0, vh4_0);
        ...
        vacc4 = _mm256_dpbusd_avx_epi32(vacc4, vone, vh4_1);
        vacc4 = _mm256_dpbusd_avx_epi32(vacc4, vone, vl4_1);
        v4_1 = _mm256_packed2planar(vl4_1, vh4_1);
        ...
        vacc4 = _mm256_dpbusd_avx_epi32(vacc4, vone, vh4_2);
        vacc4 = _mm256_dpbusd_avx_epi32(vacc4, vone, vl4_2);
        v4_2 = _mm256_packed2planar(vl4_2, vh4_2);
        ...
        vacc4 = _mm256_dpbusd_avx_epi32(vacc4, vone, vh4_3);
        vacc4 = _mm256_dpbusd_avx_epi32(vacc4, vone, vl4_3);
        v4_3 = _mm256_packed2planar(vl4_3, vh4_3);
      ...
      for (; k >= 8; k -= 8) {
        ...
        vacc0 = _mm256_dpbusd_avx_epi32(vacc0, vone, vh0);
        vacc0 = _mm256_dpbusd_avx_epi32(vacc0, vone, vl0);
        v0 = _mm256_packed2planar(vl0, vh0);
        ...
        vacc4 = _mm256_dpbusd_avx_epi32(vacc4, vone, vh4);
        vacc4 = _mm256_dpbusd_avx_epi32(vacc4, vone, vl4);
        v4 = _mm256_packed2planar(vl4, vh4);
