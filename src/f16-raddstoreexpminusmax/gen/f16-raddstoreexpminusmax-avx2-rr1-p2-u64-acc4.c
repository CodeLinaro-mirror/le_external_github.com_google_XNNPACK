...
void xnn_f16_raddstoreexpminusmax_ukernel__avx2_rr1_p2_u64_acc4(
    size_t batch,
    const void* input,
    const void* max,
    void* output,
    ...
    const union xnn_f16_expminus_params params[restrict XNN_MIN_ELEMENTS(1)]) XNN_OOB_READS
{
  ...
  XNN_FORCE_STACK const __m256 vlog2e = _mm256_set1_ps(0x1.715476p0f);
  XNN_FORCE_STACK const __m256 vmagic_bias = _mm256_set1_ps(0x1.8000FEp23f);
  XNN_FORCE_STACK const __m256 vminus_ln2 = _mm256_set1_ps(-0x1.62E43p-1f);
  XNN_FORCE_STACK const __m256 vc2 = _mm256_set1_ps(0x1.FF3A32p-2f);
  XNN_FORCE_STACK const __m256 vc1 = _mm256_set1_ps(0x1.039E10p+0f);
  XNN_FORCE_STACK const __m256 vdenorm_cutoff = _mm256_set1_ps(-0x1.368000p+3f);
