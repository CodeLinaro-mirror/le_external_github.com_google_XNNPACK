...
void xnn_f32_vsigmoid_ukernel__wasmrelaxedsimd_fma_rr2_p5_div_u12(
    size_t batch,
    const float* input,
    float* output,
    const union xnn_f32_sigmoid_params params[restrict XNN_MIN_ELEMENTS(1)]) XNN_OOB_READS
{
  ...
  XNN_FORCE_STACK const v128_t vmagic_bias = wasm_f32x4_const_splat(0x1.8000FEp23f);
  XNN_FORCE_STACK const v128_t vminus_log2e = wasm_f32x4_const_splat(-0x1.715476p+0f);
  XNN_FORCE_STACK const v128_t vln2_hi = wasm_f32x4_const_splat(0x1.62E400p-1f);
  XNN_FORCE_STACK const v128_t vln2_lo = wasm_f32x4_const_splat(0x1.7F7D1Cp-20f);
  XNN_FORCE_STACK const v128_t vc5 = wasm_f32x4_const_splat(-0x1.0F9F9Cp-7f);
  XNN_FORCE_STACK const v128_t vc4 = wasm_f32x4_const_splat(0x1.573A1Ap-5f);
  XNN_FORCE_STACK const v128_t vc3 = wasm_f32x4_const_splat(-0x1.555A80p-3f);
  XNN_FORCE_STACK const v128_t vc2 = wasm_f32x4_const_splat(0x1.FFFDC6p-2f);
  XNN_FORCE_STACK const v128_t vc1 = wasm_f32x4_const_splat(-0x1.FFFFF6p-1f);
  XNN_FORCE_STACK const v128_t vone = wasm_f32x4_const_splat(1.0f);
  XNN_FORCE_STACK const v128_t vdenorm_cutoff = wasm_f32x4_const_splat(0x1.5D589Ep+6f);
