...
void xnn_f32_vsigmoid_ukernel__wasmrelaxedsimd_fma_rr2_lut64_p2_div_u20(
    size_t batch,
    const float* input,
    float* output,
    const union xnn_f32_sigmoid_params params[restrict XNN_MIN_ELEMENTS(1)]) XNN_OOB_READS
{
  ...
  XNN_FORCE_STACK const v128_t vmagic_bias = wasm_f32x4_const_splat(0x1.800000p17f);
  XNN_FORCE_STACK const v128_t vminus_log2e = wasm_f32x4_const_splat(-0x1.715476p0f);
  XNN_FORCE_STACK const v128_t vindex_mask = wasm_u32x4_const_splat(UINT32_C(0x3F));
  XNN_FORCE_STACK const v128_t vln2_hi = wasm_f32x4_const_splat(0x1.630000p-1f);
  XNN_FORCE_STACK const v128_t vln2_lo = wasm_f32x4_const_splat(-0x1.BD0106p-13f);
  XNN_FORCE_STACK const v128_t vc2 = wasm_f32x4_const_splat(0x1.FFFF0Ap-2f);
