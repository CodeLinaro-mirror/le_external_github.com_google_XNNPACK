...
void xnn_f32_vsigmoid_ukernel__avx512f_rr2_lut32_p2_perm2_scalef_nr1fma_u128(
    size_t batch,
    const float* input,
    float* output,
    const union xnn_f32_sigmoid_params params[restrict XNN_MIN_ELEMENTS(1)])
{
  ...
  XNN_FORCE_STACK const __m512 vmagic_bias = _mm512_set1_ps(0x1.800000p18f);
  XNN_FORCE_STACK const __m512 vlog2e = _mm512_set1_ps(0x1.715476p0f);
  XNN_FORCE_STACK const __m512 vminus_ln2_hi = _mm512_set1_ps(-0x1.62E430p-1f);
  XNN_FORCE_STACK const __m512 vminus_ln2_lo = _mm512_set1_ps(0x1.05C61p-29f);
  XNN_FORCE_STACK const __m512 vc2 = _mm512_set1_ps(0x1.000000p-1f);
  XNN_FORCE_STACK const __m512 vc1 = _mm512_set1_ps(0x1.0000F6p-0f);
