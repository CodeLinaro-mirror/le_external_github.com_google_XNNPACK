...
void xnn_f32_vsigmoid_ukernel__sse2_rr2_lut64_p2_div_u20(
    size_t batch,
    const float* input,
    float* output,
    const union xnn_f32_sigmoid_params params[restrict XNN_MIN_ELEMENTS(1)]) XNN_OOB_READS
{
  ...
  XNN_FORCE_STACK const __m128 vmagic_bias = _mm_set1_ps(0x1.800000p17f);
  XNN_FORCE_STACK const __m128 vlog2e = _mm_set1_ps(0x1.715476p0f);
  XNN_FORCE_STACK const __m128 vindex_mask = _mm_set1_epi32(UINT32_C(0x3F));
  XNN_FORCE_STACK const __m128 vminus_ln2_hi = _mm_set1_ps(-0x1.630000p-1f);
  XNN_FORCE_STACK const __m128 vminus_ln2_lo = _mm_set1_ps(0x1.BD0106p-13f);
  XNN_FORCE_STACK const __m128 vc2 = _mm_set1_ps(0x1.FFFF0Ap-2f);
