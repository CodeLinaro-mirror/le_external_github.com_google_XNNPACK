...
void xnn_f32_vsigmoid_ukernel__sse41_rr2_p5_div_u16(
    size_t batch,
    const float* input,
    float* output,
    const union xnn_f32_sigmoid_params params[restrict XNN_MIN_ELEMENTS(1)]) XNN_OOB_READS
{
  ...
  XNN_FORCE_STACK const __m128 vsign_mask = _mm_set1_ps(-0.0f);
  XNN_FORCE_STACK const __m128 vmagic_bias = _mm_set1_ps(0x1.8000FEp23f);
  XNN_FORCE_STACK const __m128 vlog2e = _mm_set1_ps(0x1.715476p0f);
  XNN_FORCE_STACK const __m128 vminus_ln2_hi = _mm_set1_ps(-0x1.62E400p-1f);
  XNN_FORCE_STACK const __m128 vminus_ln2_lo = _mm_set1_ps(-0x1.7F7D1Cp-20f);
  XNN_FORCE_STACK const __m128 vc5 = _mm_set1_ps(0x1.0F9F9Cp-7f);
  XNN_FORCE_STACK const __m128 vc4 = _mm_set1_ps(0x1.573A1Ap-5f);
  XNN_FORCE_STACK const __m128 vc3 = _mm_set1_ps(0x1.555A80p-3f);
  XNN_FORCE_STACK const __m128 vc2 = _mm_set1_ps(0x1.FFFDC6p-2f);
  XNN_FORCE_STACK const __m128 vc1 = _mm_set1_ps(0x1.FFFFF6p-1f);
  XNN_FORCE_STACK const __m128 vone = _mm_set1_ps(1.0f);
  XNN_FORCE_STACK const __m128 vdenorm_cutoff = _mm_set1_ps(-0x1.5D589Ep+6f);
