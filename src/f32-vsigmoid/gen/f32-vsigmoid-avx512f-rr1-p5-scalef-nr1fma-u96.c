...
void xnn_f32_vsigmoid_ukernel__avx512f_rr1_p5_scalef_nr1fma_u96(
    size_t batch,
    const float* input,
    float* output,
    const union xnn_f32_sigmoid_params params[restrict XNN_MIN_ELEMENTS(1)])
{
  ...
  XNN_FORCE_STACK const __m512 vsign_mask = _mm512_set1_epi32(UINT32_C(0x80000000));
  XNN_FORCE_STACK const __m512 vlog2e = _mm512_set1_ps(0x1.715476p0f);
  XNN_FORCE_STACK const __m512 vminus_ln2 = _mm512_set1_ps(-0x1.62E430p-1f);
  XNN_FORCE_STACK const __m512 vc5 = _mm512_set1_ps(0x1.0F9F9Cp-7f);
  XNN_FORCE_STACK const __m512 vc4 = _mm512_set1_ps(0x1.573A1Ap-5f);
  XNN_FORCE_STACK const __m512 vc3 = _mm512_set1_ps(0x1.555A80p-3f);
  XNN_FORCE_STACK const __m512 vc2 = _mm512_set1_ps(0x1.FFFDC6p-2f);
  XNN_FORCE_STACK const __m512 vc1 = _mm512_set1_ps(0x1.FFFFF6p-1f);
  XNN_FORCE_STACK const __m512 vone = _mm512_set1_ps(1.0f);
