...
XNN_ENUM_ITEM(xnn_operator_type_sum_nd_f16, "Sum (ND, F16)")
XNN_ENUM_ITEM(xnn_operator_type_sum_nd_f32, "Sum (ND, F32)")
XNN_ENUM_ITEM(xnn_operator_type_sum_nd_qs8, "Sum (ND, QS8)")
XNN_ENUM_ITEM(xnn_operator_type_sum_nd_qu8, "Sum (ND, QU8)")
