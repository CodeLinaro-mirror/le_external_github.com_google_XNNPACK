...
typedef void (*xnn_pack_x16_gemm_fn)(
  size_t g,
  size_t nc,
  size_t kc,
  size_t nr,
...
XNN_INTERNAL void xnn_pack_x16_gemm_goi_w(
  size_t g,
  size_t nc,
  size_t kc,
  size_t nr,
...
XNN_INTERNAL void xnn_pack_x16_gemm_gio_w(
  size_t g,
  size_t nc,
  size_t kc,
  size_t nr,
...
typedef void (*xnn_pack_x16_igemm_fn)(
  size_t g,
  size_t nc,
  size_t ks,
  size_t kc,
...
XNN_INTERNAL void xnn_pack_x16_conv_kgo_w(
  size_t g,
  size_t nc,
  size_t ks,
  size_t nr,
...
XNN_INTERNAL void xnn_pack_x16_deconv_goki_w(
  size_t g,
  size_t nc,
  size_t kh,
  size_t kw,
