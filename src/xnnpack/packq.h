...
XNN_INLINE static size_t kai_k_roundedup(size_t k, size_t kr, size_t sr) {
...
XNN_INLINE static size_t kai_lhs_packed_stride(size_t k, size_t mr, size_t kr,
                                               size_t sr) {
...
DECLARE_X8_PACKQ_UKERNEL_FUNCTION(xnn_x8_packq_f32qp8_ukernel__neon_u2)
