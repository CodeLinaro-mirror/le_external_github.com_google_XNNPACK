...
{
  struct xnn_qd8_quantization_params params = xnn_qd8_asymmetric_quantization_params(xnn_fp16_ieee_to_fp32_value(min), xnn_fp16_ieee_to_fp32_value(max));
  *f16_scale = xnn_fp16_ieee_from_fp32_value(params.inv_scale);
  params.inv_scale = 1.f / params.inv_scale;
  return params;
}
