    ...
    const struct xnn_qd8_quantization_params quantization_params[restrict XNN_MIN_ELEMENTS(1)])
{
  ...
  do {
    ...
    if XNN_LIKELY(nc >= 4) {
      c0[0] = xnn_fp16_ieee_from_fp32_value(vout0x0);
      c0[1] = xnn_fp16_ieee_from_fp32_value(vout0x1);
      c0[2] = xnn_fp16_ieee_from_fp32_value(vout0x2);
      c0[3] = xnn_fp16_ieee_from_fp32_value(vout0x3);
      c1[0] = xnn_fp16_ieee_from_fp32_value(vout1x0);
      c1[1] = xnn_fp16_ieee_from_fp32_value(vout1x1);
      c1[2] = xnn_fp16_ieee_from_fp32_value(vout1x2);
      c1[3] = xnn_fp16_ieee_from_fp32_value(vout1x3);
      c2[0] = xnn_fp16_ieee_from_fp32_value(vout2x0);
      c2[1] = xnn_fp16_ieee_from_fp32_value(vout2x1);
      c2[2] = xnn_fp16_ieee_from_fp32_value(vout2x2);
      c2[3] = xnn_fp16_ieee_from_fp32_value(vout2x3);
      c3[0] = xnn_fp16_ieee_from_fp32_value(vout3x0);
      c3[1] = xnn_fp16_ieee_from_fp32_value(vout3x1);
      c3[2] = xnn_fp16_ieee_from_fp32_value(vout3x2);
      c3[3] = xnn_fp16_ieee_from_fp32_value(vout3x3);
