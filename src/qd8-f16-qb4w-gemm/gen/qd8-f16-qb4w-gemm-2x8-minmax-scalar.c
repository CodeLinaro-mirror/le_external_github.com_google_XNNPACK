    ...
    const struct xnn_qd8_quantization_params quantization_params[restrict XNN_MIN_ELEMENTS(1)])
{
  ...
  do {
    ...
    if XNN_LIKELY(nc >= 8) {
      ...
      c0[4] = xnn_fp16_ieee_from_fp32_value(vout0x4);
      c0[5] = xnn_fp16_ieee_from_fp32_value(vout0x5);
      c0[6] = xnn_fp16_ieee_from_fp32_value(vout0x6);
      c0[7] = xnn_fp16_ieee_from_fp32_value(vout0x7);
      ...
      c1[4] = xnn_fp16_ieee_from_fp32_value(vout1x4);
      c1[5] = xnn_fp16_ieee_from_fp32_value(vout1x5);
      c1[6] = xnn_fp16_ieee_from_fp32_value(vout1x6);
      c1[7] = xnn_fp16_ieee_from_fp32_value(vout1x7);
