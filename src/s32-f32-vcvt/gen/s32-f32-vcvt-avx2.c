...
void xnn_s32_f32_vcvt_ukernel__avx2_u8(
    size_t batch,
    const int32_t* input,
    float* output,
...
void xnn_s32_f32_vcvt_ukernel__avx2_u16(
    size_t batch,
    const int32_t* input,
    float* output,
    const struct xnn_s32_f32_cvt_params params[restrict XNN_MIN_ELEMENTS(1)])
...
void xnn_s32_f32_vcvt_ukernel__avx2_u24(
    size_t batch,
    const int32_t* input,
    float* output,
    const struct xnn_s32_f32_cvt_params params[restrict XNN_MIN_ELEMENTS(1)])
...
void xnn_s32_f32_vcvt_ukernel__avx2_u32(
    size_t batch,
    const int32_t* input,
    float* output,
    const struct xnn_s32_f32_cvt_params params[restrict XNN_MIN_ELEMENTS(1)])
