...
void xnn_s32_f32_vcvt_ukernel__scalar_u1(
    size_t batch,
    const int32_t* input,
    float* output,
    const struct xnn_s32_f32_cvt_params params[restrict XNN_MIN_ELEMENTS(1)])
{
  ...
  for (; batch >= xnn_simd_bytes_s32; batch -= xnn_simd_bytes_s32) {
    ...
    const xnn_simd_f32_t vy = xnn_cast_f32_s32(xnn_sub_s32(vx, sub));
...
void xnn_s32_f32_vcvt_ukernel__scalar_u2(
    size_t batch,
    const int32_t* input,
    float* output,
    const struct xnn_s32_f32_cvt_params params[restrict XNN_MIN_ELEMENTS(1)])
{
  ...
  for (; batch >= 2 * sizeof(int32_t); batch -= 2 * sizeof(int32_t)) {
    ...
    const xnn_simd_f32_t vy0 = xnn_cast_f32_s32(xnn_sub_s32(vx0, sub));
    const xnn_simd_f32_t vy1 = xnn_cast_f32_s32(xnn_sub_s32(vx1, sub));
...
void xnn_s32_f32_vcvt_ukernel__scalar_u3(
    size_t batch,
    const int32_t* input,
    float* output,
    const struct xnn_s32_f32_cvt_params params[restrict XNN_MIN_ELEMENTS(1)])
{
  ...
  for (; batch >= 3 * sizeof(int32_t); batch -= 3 * sizeof(int32_t)) {
    const xnn_simd_s32_t vx0 = xnn_loadu_s32(input);
    const xnn_simd_s32_t vx1 = xnn_loadu_s32(input + 1 * xnn_simd_size_s32);
    ...
    const xnn_simd_f32_t vy0 = xnn_cast_f32_s32(xnn_sub_s32(vx0, sub));
    const xnn_simd_f32_t vy1 = xnn_cast_f32_s32(xnn_sub_s32(vx1, sub));
    const xnn_simd_f32_t vy2 = xnn_cast_f32_s32(xnn_sub_s32(vx2, sub));
...
void xnn_s32_f32_vcvt_ukernel__scalar_u4(
    size_t batch,
    const int32_t* input,
    float* output,
    const struct xnn_s32_f32_cvt_params params[restrict XNN_MIN_ELEMENTS(1)])
{
  ...
  for (; batch >= 4 * sizeof(int32_t); batch -= 4 * sizeof(int32_t)) {
    ...
    const xnn_simd_f32_t vy1 = xnn_cast_f32_s32(xnn_sub_s32(vx1, sub));
    const xnn_simd_f32_t vy2 = xnn_cast_f32_s32(xnn_sub_s32(vx2, sub));
    const xnn_simd_f32_t vy3 = xnn_cast_f32_s32(xnn_sub_s32(vx3, sub));
