    ...
    const union xnn_f16_f32acc_scale_params params[restrict XNN_MIN_ELEMENTS(1)])
{
  ...
  for (; channels >= 128; channels -= 128) {
    ...
    __m512 vo4 = _mm512_loadu_ps(o); o = (const void*) ((uintptr_t) o + 16 * sizeof(float));
    __m512 vo5 = _mm512_loadu_ps(o); o = (const void*) ((uintptr_t) o + 16 * sizeof(float));
    __m512 vo6 = _mm512_loadu_ps(o); o = (const void*) ((uintptr_t) o + 16 * sizeof(float));
    __m512 vo7 = _mm512_loadu_ps(o); o = (const void*) ((uintptr_t) o + 16 * sizeof(float));
