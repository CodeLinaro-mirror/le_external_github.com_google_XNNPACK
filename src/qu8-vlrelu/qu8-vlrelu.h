...
XNN_UKERNEL_WITH_PARAMS(xnn_arch_riscv_vector, xnn_qu8_vlrelu_ukernel__rvv_u1v, 1, true, XNN_QUANTIZED(int8_t), struct xnn_qu8_lrelu_params, xnn_init_qu8_lrelu_scalar_params)
XNN_UKERNEL_WITH_PARAMS(xnn_arch_riscv_vector, xnn_qu8_vlrelu_ukernel__rvv_u2v, 2, true, XNN_QUANTIZED(int8_t), struct xnn_qu8_lrelu_params, xnn_init_qu8_lrelu_scalar_params)
