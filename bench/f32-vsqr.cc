...
void f32_vsqr(benchmark::State& state, xnn_f32_vsqr_ukernel_fn ukernel,
  ...
  BENCHMARK_CAPTURE(f32_vsqr, avx_u24,
    ...
    ->Apply(benchmark::utils::UnaryElementwiseParameters<float, float>)
    ->UseRealTime();
  BENCHMARK_CAPTURE(f32_vsqr, fma3_u8,
                    xnn_f32_vsqr_ukernel__fma3_u8,
                    /*init_params=*/nullptr,
                    benchmark::utils::CheckFMA3)
    ->Apply(benchmark::utils::UnaryElementwiseParameters<float, float>)
    ->UseRealTime();
  BENCHMARK_CAPTURE(f32_vsqr, fma3_u16,
                    xnn_f32_vsqr_ukernel__fma3_u16,
                    /*init_params=*/nullptr,
                    benchmark::utils::CheckFMA3)
    ->Apply(benchmark::utils::UnaryElementwiseParameters<float, float>)
    ->UseRealTime();
  BENCHMARK_CAPTURE(f32_vsqr, fma3_u24,
                    xnn_f32_vsqr_ukernel__fma3_u24,
                    /*init_params=*/nullptr,
                    benchmark::utils::CheckFMA3)
    ->Apply(benchmark::utils::UnaryElementwiseParameters<float, float>)
    ->UseRealTime();
