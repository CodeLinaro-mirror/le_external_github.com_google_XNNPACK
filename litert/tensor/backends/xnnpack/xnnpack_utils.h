...
#ifndef LITERT_TENSOR_BACKENDS_XNNPACK_XNNPACK_UTILS_H_
#define LITERT_TENSOR_BACKENDS_XNNPACK_XNNPACK_UTILS_H_
...
#endif  // LITERT_TENSOR_BACKENDS_XNNPACK_XNNPACK_UTILS_H_
