...
#ifndef LITERT_TENSOR_BACKENDS_XNNPACK_ARITHMETIC_XNNPACK_H_
#define LITERT_TENSOR_BACKENDS_XNNPACK_ARITHMETIC_XNNPACK_H_
...
#endif  // LITERT_TENSOR_BACKENDS_XNNPACK_ARITHMETIC_XNNPACK_H_
