...
TensorHandle::TensorHandle(std::source_location loc)
    : impl_(graph::NewTensor(std::move(loc))) {}

TensorHandle::TensorHandle(graph::Tensor impl) : impl_(impl) {}

TensorHandle::TensorHandle(TensorInit init, std::source_location loc)
...
TensorHandle& TensorHandle::Set(TensorInit init, std::source_location loc) & {
